[![memote tested](https://img.shields.io/badge/memote-tested-blue.svg?style=plastic)](https://mdziurzynski.github.io/tac125-metabolic-model)

# Pseudoalteromonas haloplanktis TAC125 metabolic model
...
3. Run `memote online`.
4. A history report will be publicly visible at https://mdziurzynski.github.io/tac125-metabolic-model.
